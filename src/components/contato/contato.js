    ...
    return(
        <div className={styles.container}>
            ...
            <div className={styles.container_contato}>
                    ...
                    <img src='/assets/linkedin.png' width='50' height='50' alt="icone Linkedin"/></a>
                    <a href="https://github.com/renan-oliveira93" target="_blank" rel="noreferrer">
                    < img src='/assets/github.png' width='50' height='50'  alt="icone GitHub"/></a>
                    <a href="mailto:renan_oliveira93@outlook.com.br" target="_blank" rel="noreferrer">
                    < img  src='/assets/e-mail.png'width='50' height='50' alt="icone e-mail"/></a>                                
                    <a href="https://api.whatsapp.com/send?phone=5511964885816" target="_blank" rel="noreferrer">
                    < img  src='/assets/whats-app.png' width='50' height='50'  alt="icone whats-app"/></a>
                    <a href="tel:11964885816" target="_blank" rel="noreferrer">
                    < img  src='/assets/telefone.png' width='50' height='50' alt="icone telefone"/></a>  
            </div>         
